...
export const QRCode: React.FC<QRCodeProps> = ({ location, businessName }) => {
  // Generate the review flow URL
  const reviewFlowUrl = `${window.location.origin}/review?businessId=${location.businessId}&locationId=${location.id}&reviewLink=${encodeURIComponent(location.reviewLink)}`;
